...
define(['avalon', "css!./classControlList", "user!./classControlList",
        "tab", "modal", "data_center", "PCAS"],
    function (avalon, css, html, tab, modal, data_center, PCAS) {
        var avalon_define = function () {
            var table = avalon.define({
                ...
                cbopt: function (params) {
                    if (params.type == "4") {
                        ...
                        if (this.user.department_level == "2") {
                            //所属区县
                            new PCAS("province1", "city1", "area1", "" + params.data.province + "省", "" + params.data.city + "", "" + params.data.district + "");
                            //学校名称
                ...
                cds: function (id) {
                    ...
                    ajax_post(api_class_property, {}, this);
                },
                init: function () {
                    var self = this;
                ...
                addInfo: function () {
                    ...
                    if (this.user.department_level == "2") {
                        ...
                        this.other.school_name = "";
                        new PCAS("province1", "city1", "area1", "" + this.user.province + "省", "" + this.user.city + "");
                    } else if (this.user.department_level == "4") {
            ...
            table.$watch('onReady', function () {
                new PCAS("province", "city", "area", "" + table.user.province + "省", "" + table.user.city + "");
            });
            //市级==区县获取学校
            table.$watch('user.district', function () {
                if (table.user.district != "") {
                    ajax_post(api_city_school, {district: table.user.district, department_level: 4}, this);
                } else {
                    table.city_school = [];
                }
            });
            ...
            table.$watch('compileData.fk_school_id', function () {
                if (table.compileData.fk_school_id != "") {
                    ajax_post(api_teacher_choose, {fk_school_id: table.compileData.fk_school_id}, this);
                } else {
                    table.teacherAll = [];
                }
            });
