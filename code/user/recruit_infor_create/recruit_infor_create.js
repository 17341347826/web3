...
define([ "jquery",
        C.CLF('avalon.js'),
        "layer",
        C.Co("user", "recruit_infor_create/recruit_infor_create", "css!"),
        C.Co("user", "club_notice_create/style", "css!"),
        C.Co("user", "recruit_infor_create/recruit_infor_create", "html!"),
        C.CMF("formatUtil.js"),
    ...
    function ($,avalon,layer, css1,css2,html,formatUtil,uploader, data_center) {
        ...
        //添加修改招募信息
        var api_save_update = api.api+'GrowthRecordBag/save_update_community_recruit';
        //文件上传
        var api_file_uploader = api.api+"file/uploader";
        var avalon_define = function (pmx) {
            var table = avalon.define({
                $id: "recruit_infor_create",
                highest_level: 4,
                //登陆者highest_level
                level:"",
                //社团名称
