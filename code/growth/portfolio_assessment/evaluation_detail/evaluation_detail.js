...
define(['jquery',
        ...
        'layer',
        C.CMF("formatUtil.js"),
        C.Co('growth', 'portfolio_assessment/evaluation_detail/evaluation_detail', 'html!'),
    ...
    function ($, avalon, layer, __, html, css, data_center, select_assembly, three_menu_module, jquery_print) {
        ...
        var avalon_define = function (args) {
            ...
            var vm = avalon.define({
                ...
                local_set: "",
                login_guid: "",
                get_img_file_video:function(dataList,arg){
                    if(!dataList) return;
                    var dataListLength = dataList.length;
                    for(var i=0;i<dataListLength;i++){
                        if (!dataList[i][arg] || dataList[i][arg] == null)
                            continue;
                        var fjdz = dataList[i][arg];
                        dataList[i].img_arr = [];
                ...
                init: function () {
                    ...
                    if (cloud.is_student()) {
                        ...
                        if(user_type==3){
                            grade_id = user.student.fk_grade_id;
                            school_id = user.student.fk_school_id;
                        }
                    ...
                    cloud.bgc_pdfz_detail({
                        ...
                        vm.fm.pd_list = vm.get_img_file_video(data,'attachments')
                    });
                    // 国家课程
                    cloud.bgc_kc_set({
                        guid: Number(guid),
                    ...
                    cloud.bgc_yj_detail({end_date: e, owner: Number(guid), start_date: s}, function (url, arg, data) {
                        vm.fm.yj_list = vm.get_img_file_video(data,'attachments');
                    });
                    // 健康体育活动
                    cloud.bgc_sxjk_set({
                        hea_endDate: e,
                    ...
                    cloud.bgc_sxjk_detail({
                        ...
                        vm.fm.sxjk_list = vm.get_img_file_video(data,'hea_enclosures');
                    });
                    // 艺术测评
                    cloud.bgc_ys_set({
                        art_end_time: e,
                    ...
                    cloud.bgc_ys_detail({
                        ...
                        vm.fm.ys_list = vm.get_img_file_video(data,'art_enclosures');
                    });
                    // 艺术学习情况 -需求不清晰，暂时屏蔽
                    ...
                    cloud.bgc_shsj_detail({
                        ...
                        vm.fm.shsj_list = vm.get_img_file_video(data,'attachments');
                    });
                    cloud.bgc_cjjy_set({
                        ach_end_dates: e,
                        ach_start_dates: s,
                        ...
                        vm.fm.cjjy = vm.get_img_file_video(data,'ach_enclosures');
