...
define(["jquery",
        C.CLF('avalon.js'),
        'layer',
        C.Co('evaluation_material_management', 'compre_practice/stu_upload_material/stu_upload_material','html!'),
        C.Co('evaluation_material_management', 'compre_practice/stu_upload_material/stu_upload_material','css!'),
    ...
    function ($,avalon,layer, html,css, data_center,select_assembly,three_menu_module) {
        ...
        var avalon_define = function () {
            var vm = avalon.define({
                ...
                //类型筛选
                sel_type:function () {
                    this.extend.mk = this.module_checked;
                    this.get_data();
                },
                //菜单跳转
