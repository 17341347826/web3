define(["jquery",C.CLF('avalon.js'),"layer",
        ...
        C.Co("evaluation_material/stu_evaluation","teacher_fill_list/teacher_fill_list","css!"),
        C.Co("evaluation_material/stu_evaluation","teacher_fill_list/teacher_fill_list","html!"),
        C.CMF("router.js"),
        ...
        var avalon_define = function(pmx) {
            var vm = avalon.define({
                ...
                evaluate_click:function (el) {
                    ...
                    window.location="#teacher_fill_in?guid=" + el.guid +'&id='+pmx.id+
                        '&project_id=' + pmx.pro_plan_id+'&pro_end_time='+pmx.pro_end_time+
                        '&pro_start_time='+pmx.pro_start_time+
                        '&code='+el.code+'&name='+el.name+'&sex='+el.sex+
                ...
                complete_get_complete_student:function (data) {
                    ...
                    var list = this.student_arr.$model;
