define(["jquery", C.CLF('avalon.js'), "layer",
        ...
        C.Co("evaluation_material/stu_evaluation", "project_content_list/project_content_list", "css!"),
        C.Co("evaluation_material/stu_evaluation", "project_content_list/project_content_list", "html!"),
        C.CMF("router.js"),
            ...
            var vm = avalon.define({
                ...
                evaluate_click: function (el) {
                    if (this.contentList[0].value_list.length > 0) {//选项打分
                        window.location = "#project_content_fill_radio?&grade_id=" + this.get_grade_id +
                        ...
                        window.location = "#project_content_fill?&grade_id=" + this.get_grade_id +
                            "&class_id=" + this.get_class_id +
                            "&pj_proid=" + this.pj_proid +
                            "&sub_subjectid=" + el.sub_subjectid +
                            "&school_id=" + this.school_id +
