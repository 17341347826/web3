...
define(['jquery',
        C.CLF('avalon.js'),
        'layer',
        C.Co('weixin_pj', 'progress_wx_sh/progress_wx_sh', 'html!'),
        C.Co('weixin_pj', 'progress_wx_sh/progress_wx_sh', 'css!'),
        ...
        var avalon_define = function () {
            var vm = avalon.define({
                ...
                init: function () {
                    ...
                    this.semester_arr = any_2_select(semester_full, {name: "semester_name", value: ["id","start_date","end_date"]});
                ...
                semester_sel: function (el) {
                    ...
                    cloud.pj_shfy_process(self.par, function (url, ars, data, is_suc, msg) {
                        ...
                        if (data != null){
                         ...
                         console.log(data)
                        console.log(self.class_overall_audit_list)
                        console.log(self.reconsider_audit_List)
                        console.log(self.upload_material_audit_list)
                    });
                },
