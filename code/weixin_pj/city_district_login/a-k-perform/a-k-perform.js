...
define(['jquery',
        ...
        C.Co('weixin_pj', 'city_district_login/a-k-perform/a-k-perform', 'html!'),
        C.Co('weixin_pj', 'city_district_login/a-k-perform/a-k-perform', 'css!'),
        ...
        var avalon_define = function (prm) {
            var vm = avalon.define({
                ...
                complete_index_detail:function(data){
                    ...
                    $("#select2-teacher_select-container").text(this.data.index_author +'--'+tea_num+'【'+this.data.index_authorid+'】');
                    //适用年级开始
            ...
            vm.$watch('data.index_review',function(){
                vm.mainPoints_num = vm.data.index_review.length;
            });
            return vm;
        };
        return {
