...
define([C.CLF("avalon.js"),
        'jquery',
        C.Co('weixin_pj', 'parent_login/parent_home/parent_home','html!'),
        C.Co('weixin_pj', 'parent_login/parent_home/parent_home','css!'),
        C.CMF("router.js"),
    ...
    function (avalon,$,html,css,x,data_center,weui,highcharts,highcharts_more,notice_module_wx,bt) {
        //获取学年学期
            ...
            var vm = avalon.define({
                    ...
                    if (is_suc) {
                        switch (cmd) {
                            case pending_url:
                                ...
                                //     {"mod":"成就奖励","count":1,"href":"#achieveCheck","title":"待评价","type":"1"},
                            ...
                            case add_record:
                                // this.good_list = [
                                //     {item:'很好很好很好很好1很好很好很好很好1很好很好很好很好1很好很好很好很好1很好很好很好很好1很好很好很好很好1'},
                                //     {item:'很好很好很好很好2'},
                                //     {item:'很好很好很好很好3'},
                                //     {item:'很好很好很好很好4'},
                                //     {item:'很好很好很好很好2'},
                ...
                cb: function() {
                    ...
                    data_center.uin(function(data) {
                        ...
                        self.stu_info = tUserData.student;
                        switch (user_type) {
                            case 2://学生
