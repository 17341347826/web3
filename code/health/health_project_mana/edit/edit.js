...
define([
        ...
        C.Co("health", "health_project_mana/edit/edit", "css!"),
        C.Co("health", "health_project_mana/edit/edit", "html!"),
    ...
    function ($, avalon,date_zh, css, html, data_center,layer) {
        ...
        var avalon_define = function (pms) {
            var new_health_item = avalon.define({
                ...
                //取消
                cancel_btn:function(){
                    window.location="#health_project_mana?grade_id="+pms.grade_id+
                        '&is_switch='+pms.is_switch+'&module_type='+pms.module_type;
                },
                save_click:function () {
