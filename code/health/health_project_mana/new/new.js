...
define([
        ...
        'layer',
        "date_zh",
        C.Co('health', 'health_project_mana/new/new', 'html!'),
        C.Co('health', 'health_project_mana/new/new', 'css!'),
            ...
            var vm = avalon.define({
                ...
                get_grade_id:function () {
                    ...
                    if(grade_name==0){
                        ...
                        this.project_data.due_grade= remart_2_no(grade_name);
                        this.add_data.due_grade=remart_2_no(grade_name);
                ...
                complete_save_health_project_new:function (data) {
                    ...
                    window.setTimeout(function () {
                        window.location="#health_project_mana?grade_id="+pxm.grade_id+
