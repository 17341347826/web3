...
define([
        "jquery",
        C.CLF('avalon.js'),
        C.Co("health", "health_item_mana/edit/edit", "css!"),
        C.Co("health", "health_item_mana/edit/edit", "html!"),
                    ...
                    if (is_suc) {
                        switch (cmd) {
                            ...
                            case url_health_item_edit:{
                                window.location.href = "#health_item_mana?grade_id="+params.grade_id+'&is_switch='+params.is_switch+
