define(["jquery",
        ...
        C.Co("questionnaire_investigation","add_simple_question/add_simple_question","html!"),
        C.CMF("router.js"),
        C.CMF("data_center.js"),
        C.Co("notice", "create_notice/style", "css!"),
        C.CM("three_menu_module")
    ],
    function($,avalon,layer,css, html, x, data_center,css2,three_menu_module) {
        ...
        var avalon_define = function(par) {
            var vm = avalon.define({
                ...
                complete_simple:function () {
                    ...
                    this.save_question();
                    // ajax_post(save_question,this.post_data.$model,this);
                },
