...
define(["jquery", C.CLF('avalon.js'), 'layer', "date_zh",
        C.Co("self_evaluation_management", "self_evaluation/student_self_evaluation/student_self_evaluation", "css!"),
        C.Co("self_evaluation_management", "self_evaluation/student_self_evaluation/student_self_evaluation", "html!"),
        C.CMF("router.js"), C.CMF("data_center.js"), C.CM("table"),
        C.CM('three_menu_module'), C.CM("select_assembly")

    ],
    function ($, avalon, layer, date_zh, css, html, x, data_center, tab, three_menu_module, select_assembly) {
        //获取年级
        ...
        var avalon_define = function (pmx) {
            var vm = avalon.define({
                ...
                //创建
                self_add: function () {
                    window.location = '#student_add_self_evaluation?grade_id='+pmx.grade_id+'&is_switch='+pmx.is_switch+
                ...
                add_programme: function () {
                    var id = "";
                    data_center.set_key("get_self_id", id);
                    window.location = "#student_add_self_evaluation?grade_id="+pmx.grade_id+'&is_switch='+pmx.is_switch+
                        '&module_type='+pmx.module_type + "&grade_name=" + pmx.grade_name;
                },
                cbopt: function (params) {
                    ...
                    if (params.type == 2) {//删除
                        ...
                        window.location = "#student_add_self_evaluation?params_type=" + 1 + "&get_self_id=" + id+
                            "&grade_id="+pmx.grade_id+'&is_switch='+pmx.is_switch+
                            '&module_type='+pmx.module_type + "&grade_name=" + pmx.grade_name;
                    }
                },
                ...
                go_href:function () {
                    window.location = "#item_programme_management?url_type="+1+'&grade_id='+pmx.grade_id+'&is_switch='+pmx.is_switch+
                                        '&module_type='+pmx.module_type + "&grade_name=" + pmx.grade_name;
                },
                onBlack: function () {
                    window.history.go(-1);
