 ...
 */
define([C.CLF('avalon.js'),"jquery","date_zh",'layer',
        C.Co("evaluate_students","peer_review/student_add_mutual_evaluation/student_add_mutual_evaluation","css!"),
        C.Co("evaluate_students","peer_review/student_add_mutual_evaluation/student_add_mutual_evaluation","html!"),
        C.CMF("router.js"),C.CMF("data_center.js"),C.CM("table")],
    function(avalon, $, date_zh, layer, css, html, x, data_center,tab) {
        //获取年级
        ...
        var avalon_define = function(pxm) {
            var vm = avalon.define({
                ...
                request_data: {
                    ...
                    pro_type:2,
                    plan_level:"",
                    pro_group_type:2//number 1:随机分配2:小组互评
                },
                is_add_data:{
                    pro_end_time:"",
                    pro_gradeid:"",
                ...
                //修改项目
                get_id:function () {
                    this.id=pxm.get_mutual_id;
                    this.request_data.id=pxm.get_mutual_id;
                },
                check_item:function () {
                ...
                get_apply_grade:function () {
                    ...
                    var remark = grade.split("|")[0];
                    var id = this.grade_remark(remark);
                    ajax_post(api_get_refer,{plan_gradeid:id,plan_subjectid:2,plan_check_state:2,plan_use_state:1},this);
                },
                //选用方案
                ...
                cancel_click:function(){
                    ...
                    this.reference_arr='';
                    window.location="#student_mutual_evaluation?&grade_id="+pxm.grade_id+
                        '&is_switch='+pxm.is_switch+'&module_type='+pxm.module_type;
                },
                //添加
                add_click:function () {
                    var grade=this.grade_info;
                    ...
                    // else if(this.request_data.pro_group_type == 0){
                    ...
                    // }
                        ...
                        if(this.id){//修改
                            ...
                            // this.is_add_data.pro_end_time = '2018-03-04 00:00';
                            // this.is_add_data.pro_start_time = '2018-03-03 00:00';
                ...
                complete_add_plan:function (data) {
                    //设置默认参数设置
                    ajax_post(api_add_setting,{evaluate_number:3,score_limit:0},this);
                },
                //参数设置
