define([
        C.CLF('avalon.js'),
        'layer',
        C.Co('evaluation_analysis', 'analysis/analysis', 'html!'),
        C.Co('evaluation_analysis', 'analysis/analysis', 'css!'),
        C.CMF("data_center.js"),
        C.CM("select_assembly"),
        "select2",
        C.CM("three_menu_module"),"highcharts", "highcharts_more","highcharts-zh_CN"
    ],
    function (avalon, layer, html, css, data_center, select_assembly, select2, three_menu_module,highcharts,highcharts_more,highcharts_zh) {
