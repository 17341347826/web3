define([
        C.CLF('avalon.js'),
        'layer',
        C.Co('daily_evaluation_statistics', 'daily_region_special/daily_region_special', 'html!'),
    ...
    function (avalon, layer, html, css, data_center, select_assembly, echarts, select2, three_menu_module) {
        var msg_api = api.growth + "daily_perfor_and_personality_eval_sta_analysis_qyfx";
        var user = {};
                ...
                presentation_change:function (num) {
                    ...
                    switch (dis){
                        case 1:
                            break;
                        case 2:
                            this.to_page('daily_region_ana?sta_type=2&module_type=8');
                            break;
                        case 3:
                            this.to_page('daily_region_ana?sta_type=3&module_type=8');
                            break;
                        default:
                            break;
                    }
                ...
                deal_data: function (data, type, div_id) {
                    ...
                    for (var i = data_length-1; i >-1; i--) {
                        ...
                        if(type=='city'){
                            ...
                            sczb = Number(Number(data[i].pjdf)+Number(data[i].gx_pjdf));
                        }
                        if(type=='district'){
                        ...
                        if(type=='school'){
                            ...
                            sczb = Number(Number(data[i].detail.pjdf)+Number(data[i].detail.gx_pjdf));
                        }
                        if(type=='class'){
