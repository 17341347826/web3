define([
        C.CLF('avalon.js'),
        'layer',
        C.Co('daily_evaluation_statistics', 'daily_portrait_special/daily_portrait_special', 'html!'),
    ...
    function (avalon, layer, html, css, data_center, select_assembly, echarts, three_menu_module) {
        var msg_api = api.growth + "daily_perfor_and_personality_eval_sta_analysis_zxfx";
        var user = {};
                ...
                presentation_change:function (num) {
                    ...
                    switch (dis){
                        case 1:
                            break;
                        case 2:
                            this.to_page('daily_vertical_ana?sta_type=2&module_type=8');
                            break;
                        case 3:
                            this.to_page('daily_vertical_ana?sta_type=3&module_type=8');
                            break;
                        default:
                            break;
                    }
                ...
                deal_data: function (data, type, div_id) {
                    ...
                    for (var i = data_length-1; i >-1; i--) {
                        ...
                        if(type=='city'){
                            ...
                            sczb = Number(data[i].rc_pjf+data[i].gx_pjf);
                        }
                        if(type=='district'){
                        ...
                        if(type=='school'){
                            ...
                            sczb = Number(data[i].detail.rc_pjf+data[i].detail.gx_pjf);
                        }
                        if(type=='class'){
