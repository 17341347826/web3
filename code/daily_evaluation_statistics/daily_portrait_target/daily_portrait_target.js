define([
        C.CLF('avalon.js'),
        'layer',
        C.Co('daily_evaluation_statistics', 'daily_portrait_target/daily_portrait_target', 'html!'),
    ...
    function (avalon, layer, html, css, data_center, select_assembly, echarts, three_menu_module) {
        var msg_api = api.growth + "every_day_goal_and_plan_completion_zxfx";
        var user = {};
                ...
                deal_msg: function (data) {
                    ...
                    if (data.data.school_cnt) {
                        ...
                        setTimeout(function () {
                            ...
                            if (new_cnt.length > 0 && vm.user_level < 4) {
                                vm.school_p.district_name = new_cnt[0].district_name;
                                vm.defalut_area_school = vm.school_p.district_name;
                            }
                            if (vm.user_level < 4 && new_cnt.length > 0) {
                                vm.get_school_list(new_cnt);
                            }
                    ...
                    if (data.data.school_class_cnt) {
                        ...
                        setTimeout(function () {
                            ...
                            vm.order_by_class = new_cnt;
                            vm.deal_data(vm.order_by_class, 'class', 'tubiao_4')
                        },0)
