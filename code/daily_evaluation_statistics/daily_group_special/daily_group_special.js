define([
        C.CLF('avalon.js'),
        'layer',
        C.Co('daily_evaluation_statistics', 'daily_group_special/daily_group_special', 'html!'),
    ...
    function (avalon, layer, html, css, data_center, select_assembly, echarts, three_menu_module) {
        var zsqk_api = api.growth + "daily_perfor_and_personality_eval_sta_analysis_zsqk";
        var sex_api = api.growth + "daily_perfor_and_personality_eval_sta_analysis_sex";
        var user = {};

        var avalon_define = function () {

            var vm = avalon.define({
                $id: "daily_group_special",
                ...
                presentation_change:function (num) {
                    ...
                    switch (dis){
                        case 1:
                            break;
                        case 2:
                            this.to_page('daily_group_wd?sta_type=2&module_type=8');
                            break;
                        case 3:
                            this.to_page('daily_group_ys?sta_type=3&module_type=8');
                            break;
                        default:
                            break;
                    }
                ...
                deal_data: function (data, type, div_id) {
                    ...
                    for (var i = data_length - 1; i > -1; i--) {
                        ...
                        if (type == 'city') {
                            ...
                            sczb = Number(data[i].gx_pjdf+data[i].pjdf);
                        }
                        if (type == 'district') {
                        ...
                        if (type == 'school') {
                            ...
                            sczb = Number(data[i].detail.gx_pjdf+data[i].detail.pjdf);
                        }
                        if (type == 'class') {
                    ...
                    DailyAnaly.draw_bar(div_id, echarts, series_arr, yAxis_arr, legend_arr,this.user_level);
                },
