define([
        C.CLF('avalon.js'),
        'layer',
        C.Co('daily_evaluation_statistics', 'daily_comprehensive_practice/daily_comprehensive_practice', 'html!'),
        ...
        var avalon_define = function () {
            var vm = avalon.define({
                ...
                presentation_change:function (num) {
                    ...
                    switch (dis){
                        case 1:
                            break;
                        case 2:
                            this.to_page('#daily_comprehensive_practice_wd?sta_type=2&module_type=4&page=not_school');
                            break;
                        case 3:
                            this.to_page('#daily_comprehensive_practice_wd?sta_type=3&module_type=4&page=not_school');
                            break;
                        default:
                            break;
                    }
                ...
                search: function () {
                    ...
                    this.deal_data(this.filter_school(this.school_process_list), 'school_name', 'tubiao_3')
                },
                //初始前期数据
                init_data: function () {
                ...
                deal_msg: function (data) {
                    ...
                    if (data.data.city_cnt) {
                        // data.data.city_cnt = this.data_reorganization(data.data.city_cnt);
                    ...
                    if (data.data.district_cnt) {
                        // data.data.district_cnt = this.data_reorganization(data.data.district_cnt);
                        this.area_process_list = data.data.district_cnt;
                        if(this.user_level<4)
                            this.deal_data(this.filter_area(this.area_process_list), 'district', 'tubiao_2');
                    }
                    if (data.data.school_cnt) {
                        // data.data.school_cnt = this.data_reorganization(data.data.school_cnt);
                        data.data.school_cnt.sort(by('school_name'))
                        setTimeout(function () {
                            vm.school_process_list = data.data.school_cnt;
                            vm.old_school_process_list = data.data.school_cnt;
