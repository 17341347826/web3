define([
        C.CLF('avalon.js'),
        'layer',
        C.Co('daily_evaluation_statistics', 'daily_group_target/daily_group_target', 'html!'),
    ...
    function (avalon, layer, html, css, data_center, select_assembly, echarts, three_menu_module) {
        var zsqk_api = api.growth + "every_day_goal_and_plan_completion_zsqk";
        var sex_api = api.growth + "every_day_goal_and_plan_completion_sex";
        var user = {};
            ...
            var vm = avalon.define({
                ...
                deal_msg: function (data) {
                    ...
                    if (data.data.school_class_cnt) {
                        ...
                        var new_cnt = DailyAnaly.complate_data(school_class_cnt,['grade_name','grade_id','class_id','bjmc'],key2,arr,'--');
