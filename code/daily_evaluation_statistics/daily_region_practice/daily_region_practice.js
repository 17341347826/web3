define([
        C.CLF('avalon.js'),
        'layer',
        C.Co('daily_evaluation_statistics', 'daily_region_practice/daily_region_practice', 'html!'),
    ...
    function (avalon, layer, html, css, data_center, select_assembly, echarts, three_menu_module) {
        var msg_api = api.growth + "every_day_comprehensive_practical_activities_qyfx";
        var user = {};
                ...
                presentation_change:function (num) {
                    ...
                    switch (dis){
                        case 1:
                            break;
                        case 2:
                            this.to_page('daily_region_ana?sta_type=2&module_type=4');
                            break;
                        case 3:
                            this.to_page('daily_region_ana?sta_type=3&module_type=4');
                            break;
                        default:
                            break;
                    }
                ...
                deal_msg: function (data) {
                    ...
                    if (data.data.district_cnt) {
                        ...
                        if(district_cnt.length>0)
                            ...
                            this.default_area_area = vm.area_p.district_name;
                    ...
                    if (data.data.school_cnt) {
                        ...
                        if(school_cnt.length>0 && this.user_level<4)
