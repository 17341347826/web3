...
define(["jquery",C.CLF('avalon.js'),'layer',"date_zh",
        C.Co("eval_param_set","task_control_see/student_mutual_evaluation_see/student_mutual_evaluation_see","css!"),
        C.Co("eval_param_set","task_control_see/student_mutual_evaluation_see/student_mutual_evaluation_see","html!"),
    ...
    function($,avalon, layer,date_zh,css, html, x, data_center,page_title,tab,three_menu_module,select_assembly) {
        ...
        var avalon_define = function(pmx) {
            var vm = avalon.define({
                $id: "student_mutual_evaluation_see",
                url:api_find_plan,
                type:"",
                is_init: false,
                data: {
