...
define(["jquery", C.CLF('avalon.js'), 'layer', "date_zh",
        C.Co("eval_param_set", "task_control_see/student_self_evaluation_see/student_self_evaluation_see", "css!"),
        C.Co("eval_param_set", "task_control_see/student_self_evaluation_see/student_self_evaluation_see", "html!"),
    ...
    function ($, avalon, layer, date_zh, css, html, x, data_center, tab, three_menu_module, select_assembly) {
        ...
        var avalon_define = function (pmx) {
            var vm = avalon.define({
                $id: "student_self_evaluation_see",
                url: api_find_plan,
                type: "",
                is_init: false,
                data: {
                ...
                go_href:function () {
                    window.location = "#item_programme_management_see?url_type="+1+'&grade_id='+pmx.grade_id+'&is_switch='+pmx.is_switch+
                        '&module_type='+pmx.module_type + "&grade_name=" + pmx.grade_name;
                }
