...
define(["jquery",
        C.CLF('avalon.js'),
        'layer',
        C.Co('eval_param_set', 'e_task_control/real_a_type_set/real_a_type_set','html!'),
        C.Co('eval_param_set', 'e_task_control/real_a_type_set/real_a_type_set','css!'),
            ...
            var vm = avalon.define({
                ...
                theadTh: [{
                    ...
                    },
                    {
                        ...
                        type: "html",
                        from:
                        "<a class='tab-btn tab-edit-btn' ms-on-click='@oncbopt({current:$idx, type:1})' title='编辑'></a>" +
                ...
                cbopt: function(params) {
                    ...
                    switch(params.type){
                        case 1:
                            window.location = "#type_set_add?type_id="+id+'&grade_id='+pmx.grade_id+'&is_switch='+pmx.is_switch+
                ...
                create_type:function(){
                    window.location = '#type_set_add?grade_id='+pmx.grade_id+'&is_switch='+pmx.is_switch+
                    '&module_type='+pmx.module_type+'&start_time='+pmx.start_time+'&end_time='+pmx.end_time;
                },
                init:function () {
                    this.cb();
