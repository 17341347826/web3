...
define(['jquery',C.CLF('avalon.js'), "layer",
        C.Co("eval_param_set","term_statistics_local/term_statistics_local",'css!'),
        C.Co("eval_param_set","term_statistics_local/term_statistics_local",'html!'),
