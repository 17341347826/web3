...
define([
        ...
        C.Co("all_index", "share_adopt_first_examine/share_adopt_first_examine", "html!"),
        "layer",
        C.CM("table"),
        ...
        var avalon_define = function () {
            ...
            var vm = avalon.define({
                ...
                extend: {
                    ...
                    index_rank: 1,//指标等级(1:一级2:二级3:三级)
                    __hash__: ""
                },
                // 列表表头名称
                theadTh: [{
...

                    {
                        title: "操作",
                        type: "html",
                        // from: "<a :if='el.index_state==1' class='tab-btn tab-audit-btn' ms-on-click='@oncbopt({current:$idx, type:2})' title='审核'></a>"+
                        // "<a :if='el.index_state!=1' class='tab-btn tab-audit-btn-disabled' disabled='disabled' title='审核'></a>"
                        from: '<input type="button" ms-attr="{disabled:el.index_state!=1}" ' +
                        ':class="[(el.index_state==1 ? \'tab-audit-btn\':\'tab-audit-btn-disabled\'),\'tab-btn\']" ' +
                        'ms-on-click="@oncbopt({current:$idx,type:2})" title="审核">'
                    }],
                ...
                //     this.extend.index_state=this.index_state;
