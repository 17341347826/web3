...
define(["jquery",
        C.CLF('avalon.js'),
        C.Co("all_index", "achieve_maintenance_scheme/achieve_maintenance_scheme", "css!"),
        C.Co("all_index", "achieve_maintenance_scheme/achieve_maintenance_scheme", "html!"),
        C.CM("table"),
        C.CM('page_title'),
        "layer",
        C.CMF("router.js"), C.CM("three_menu_module"),
        C.CMF("data_center.js")],
    function ($,avalon, css, html, tab,page_title, layer,router,three_menu_module, data_center) {
        //查询成就奖励积分
        ...
        var avalon_define = function(pmx) {
            var table = avalon.define({
                $id: "achieve_maintenance_scheme",
                //登陆者身份等级：user_type='1' 时才有值。1：省级；2：市州级；3：区县级；4：校级；5：年级；6：班主任或普通任课教师
                user_level:'',
                ...
                cds: function() {
                    ...
                    data_center.uin(function(data) {
                        ...
                        self.user_level = data.data.highest_level;
                        //请求列表
                        self.list_achieve();
                    });
                },
