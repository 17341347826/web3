...
define(["jquery",
        C.CLF('avalon.js'),
        'layer',
        C.Co('all_index', 'evaluation_scheme/evaluation_scheme', 'html!'),
        C.Co('all_index', 'evaluation_scheme/evaluation_scheme', 'css!'),
    ...
    function ($,avalon, layer, html, css, data_center, select_assembly, three_menu_module, select2) {
        var avalon_define = function (args) {
            ...
            var vm = avalon.define({
                ...
                init: function () {
                    ...
                    setTimeout(function () {
                        ...
                        if (mod >= 2&&!vm.is_nor_user) {
                            ...
                            vm.change_area(vm.area_list[0], -1);
                ...
                change_area: function (value, index) {
                    vm.fm.district_id = value.value;
                    vm.fm.district = value.name;
...
//                             area_list = cloud.area_list();
//                             vm.area_list = any_2_select(area_list, {name: "district", value: ["id"]});
//                             vm.change_area(vm.area_list[0], 0);
//                             if (vm.user_level == 3 && mod == 2) {
//                                 vm.form_rcpj.cjrdw_id = cloud.user_depart_id();
//                                 vm.form_mzpj.index_workid = cloud.user_depart_id();
//                                 vm.form_mzpj.department_level = '3';
//                             }
...
//
//                         if (mod >= 3) {
//                             console.log(cloud.is_school_user());
//                             if (!cloud.is_school_user())
//                                 vm.query_school();
//                             else
//                             {
...
//                         vm.first_index_list = cloud.index_list_xz({});
//                         vm.first_index_list.reverse();
//                         var ts_list = cloud.index_list_ts({index_rank: 1});
//                         ts_list.forEach(function (data) {
//                             var ft = base_filter(vm.first_index_list.$model, "index_name", data.index_name);
//                             if(ft.length==0)
//                                 vm.first_index_list.push(data);
...
//                     if (grade_list[index].hasOwnProperty("remark")){
//                         this.form_rcpj.synj = grade_list[index].remark;
//                         this.form_mzpj.index_gradeid = grade_list[index].id;
//                     }else{
//                         this.form_rcpj.synj = grade_list[index].detail.remark;
//                         this.form_mzpj.index_gradeid = grade_list[index].id;
//                     }
...
//                     cloud.detail_mzpy(this.form_mzpj.$model, function (url, args, data) {
//                         if (data.length == 0) {
//                             vm.mzpy_list = [{kcyd: "温馨提示：暂无数据", no_info: 1}]
//                         } else {
//                             vm.mzpy_list = data;
//
//                         }
//                     });
//                     // ajax_post(api_democratic_eval,this.form_mzpj.$model,this);
//                 },
//                 //查询日常评价
//                 query_rcpj: function () {
//                     cloud.detail_rcpj(this.form_rcpj.$model, function (url, args, data) {
//                         if (data.length == 0) {
//                             vm.rcbx_list = [{kcyd: "温馨提示：暂无数据", no_info: 1}]
//                         } else {
//                             vm.rcbx_list = data;
//
//                         }
