...
define(["jquery",
        ...
        C.Co("all_index", "school_t_e_s_s/school_t_e_s_s", "css!"),
        C.Co("all_index", "school_t_e_s_s/school_t_e_s_s", "html!"),
        C.CMF("router.js"),
        ...
        var avalon_define = function (pmx) {
            var vm = avalon.define({
                ...
                extend: {
                    ...
                    plan_name: "",
                    plan_school_typeid: "",
                    plan_subjectid: '',//1:学生自评 2:学生互评 3:教师评价 4:全部（自评/组评/班评）
                ...
                cbopt: function (params) {
                    ...
                    var grade_id = params.data.plan_gradeid;//年级id
                    ...
                    if (params.type == 1) {//启用
                        ...
                        window.location = "#school_detail?&plan_type=" + plan_type + "&id=" + id + "&grade=" + grade +
                            ...
                            plan_name + "&plan_level=" +plan_level+'&grade_id='+grade_id;
