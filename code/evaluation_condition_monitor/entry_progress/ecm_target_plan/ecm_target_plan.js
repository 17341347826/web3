...
define(["jquery",
        C.CLF('avalon.js'),
        'layer',
        C.Co('evaluation_condition_monitor', 'entry_progress/ecm_target_plan/ecm_target_plan','html!'),
        C.Co('evaluation_condition_monitor', 'entry_progress/ecm_target_plan/ecm_target_plan','css!'),
               ...
               type:"",
                ...
                change_sems: function (value, index) {
                    ...
                    cloud.class_process_mb(this.form_list.$model, function (url, args, data) {
                        ...
                        vm.line_offset = Math.ceil(data.detail_list.length/2);
