define([
        C.CLF('avalon.js'),
        'layer',
        C.Co('evaluation_supervision', 'upload-active/upload-active', 'html!'),
    ...
    function (avalon, layer, html, css, data_center, select_assembly, echarts, three_menu_module, formatUtil) {
        ...
        var avalon_define = function () {
            const data_api = api.api + "GrowthRecordBag/hdsc_input_progress";
            //手动刷新接口
            ...
            var vm = avalon.define({
                ...
                get_class_data: function () {
                    ...
                    draw_class_bar(echarts, vm.filter_class(this.data.class_cnt), 'zh_scxszb')
                },
                ...
                filter_class: make_filter(function (line) {
                    if ((line.fk_nj_id == vm.class_grade_id || vm.class_grade_id == '') &&
                        (line.fk_bj_id == vm.class_class_id || vm.class_class_id == '')) {
                        return true;
                    }
                    return false;
                }),
                ...
                draw_circle: function (id, data) {
                    setTimeout(function () {
                        draw_circle(echarts, id, data, 'zh_scxszb')
                    }, 10)
                },
                /**
                 * 区县画柱状图
                ...
                draw_bar: function () {
                    setTimeout(function () {
                        ...
                        const data_for_bar = bar_data(district_cnt, 'area', 'zh_scxszb');
                ...
                school_data_deal: function (area) {
                    ...
                    Screen.filter_data(area, function (new_cnt) {
                        ...
                        const data_for_bar = bar_data(vm.data_school, 'school', 'zh_scxszb');
