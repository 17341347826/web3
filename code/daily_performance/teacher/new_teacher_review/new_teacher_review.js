...
define([
        ...
        C.CLF('avalon.js'),
        'layer',
        C.Co('daily_performance/teacher', 'new_teacher_review/new_teacher_review', 'html!'),
        C.Co('daily_performance/teacher', 'new_teacher_review/new_teacher_review', 'css!'),
                ...
                deal_index: function (data) {
                    ...
                    switch (module_index) {
                        case 0:
                            ...
                            cloud.audit_morality(this.request_data.$model, function (url, args, data) {
                        ...
                        case 1:
                            this.request_data.frist_index = data.data.first_index_name;
                            this.request_data.second_index = data.data.second_index_name;
                            cloud.audit_study(this.request_data.$model, function (url, args, data) {
                                vm.had_checked(vm.request_data.id);
                            });
                            break;
                        case 2:
                            ...
                            cloud.audit_health_activity(this.request_data.$model, function (url, args, data) {
                                vm.had_checked(vm.request_data.id);
                            });
                            break;
                        case 3:
                            ...
                            cloud.audit_artactivity(this.request_data.$model, function (url, args, data) {
                                vm.had_checked(vm.request_data.id);
                            });
                            break;
                        case 4:
                            this.request_data.frist_index = data.data.first_index_name;
                            this.request_data.second_index = data.data.second_index_name;
                            cloud.audit_practice(this.request_data.$model, function (url, args, data) {
                                vm.had_checked(vm.request_data.id);
                            });
                            break;
                        case 5:
                            cloud.audit_everyday(this.request_data.$model, function (url, args, data) {
                                vm.had_checked(vm.request_data.id);
                            });
                            break;
                        case 6:
                            ...
                            cloud.audit_achievement(this.request_data.$model, function (url, args, data) {
                                vm.had_checked(vm.request_data.id);
                            });
                            break;
                        default:
