define([
        ...
        C.CLF('avalon.js'),
        'layer',
        C.Co("daily_performance", "publicity/ph_test_list/ph_test_list", "css!"),
        C.Co("daily_performance", "publicity/ph_test_list/ph_test_list", "html!"),
        C.CMF("router.js"),
        C.CMF("data_center.js"),
        C.CM('three_menu_module'),
        C.CM("table")
    ],
    function ($, avalon, layer, css, html, x, data_center, three_menu_module, tab) {
        //审核公式管控-查询
        ...
        var avalon_define = function () {
            var vm = avalon.define({
                ...
                get_title_score: function () {
                    ...
                    this.extend.guid__in  = student_list;
