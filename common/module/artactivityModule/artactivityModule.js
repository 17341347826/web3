...
define([
    ...
    function(avalon,css, html, x, data_center,layer) {
        ...
        // 艺术活动基本详细信息组件
        var detail = avalon.component('ms-base-artactivity-detail', {
            template: html,
            defaults: {
                url_file:"",//获取文件
                url:"",//获取学生艺术详情
                ...
                artactivityGetDetalisById: function() { //get详细
                    this.data.id = data_center.get_key("art_id");
                ...
                on_request_complete: function(cmd, status, data, is_suc, msg) {
                    if (is_suc) {
                        switch (cmd) {
                            case this.url:
                                complete_getArtactivityDetailById(data);
                                break;
                        }
                    }
                },
                onReady: function() {
                    ...
                    this.cb();
                    this.artactivityGetDetalisById();
                },
                //视频
                ...
                //修正照片
                update_img:function () {
                    sessionStorage.setItem("art_data_detail", JSON.stringify(this.data));
                    window.location="#art_update_img";
                }
        ...
        complete_getArtactivityDetailById = function(data) {
            var dataList=data.data;
            var data_attachment=dataList.art_enclosures;
            ...
            if(pdetail.teacher_check==1 && data.data.art_enclosures.length==0){
