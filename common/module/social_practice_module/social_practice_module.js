...
define([
        ...
        C.CM("social_practice_module","html!"),
        C.CMF("router.js"),
        C.CMF("data_center.js"),
        "amazeui",
        "layer"],
    function(avalon,$, css, html, x, data_center,amazeui,layer) {
        var pdetail = undefined;
        // 作品基本详细信息组件
        var detail = avalon.component('ms-base-social-practice-detail', {
            template: html,
            defaults: {
                url_file:"",//获取文件
                url:"",//获取社会实践详情
                ...
                //修正照片
                update_img:function () {
                    sessionStorage.setItem("soc_data_detail", JSON.stringify(this.data));
                    window.location="#soc_update_img";
                }
            }
        })
