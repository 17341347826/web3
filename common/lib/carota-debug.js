		...
		"src": {
				...
				exports.create = function(element) {
				    ...
				    element.innerHTML =
				        ...
				        '<div class="carotaTextArea" style="overflow: hidden; position: absolute; height: 0;">' +
				            ...
				            'style="position: absolute; padding: 0px; width: 367px; height: 1em; ' +
				    ...
				    dom.handleEvent(textArea, 'input', function(evt) {
				        console.info(evt.inputType)
				        var newText = textArea.value;
				        var text_code = newText.charCodeAt(0);
				        var valid_key = [229, 32]
				        var valid_key_event = ["insertLineBreak", "insertText", "insertFromPaste", "deleteContentBackward"];
				        if (valid_key_event.indexOf(evt.inputType)>=0 || (evt.inputType == "insertCompositionText"&&valid_key.indexOf(text_code)<0) ){
				
				
				            //console.info("text_code:", text_code, "data:", new Date());
				           // console.info(textArea.innerText.length, textArea.value.length);
				            if ( textAreaContent != newText&&  text_code!=229) {
				                textAreaContent = '';
				                textArea.value = '';
			...
			"text.js": function (exports, module, require) {
				...
				//    div.style.width = '500px';
				    ...
				    // if(text.indexOf("诚实守信是中华民族的优良传统")>=0){
